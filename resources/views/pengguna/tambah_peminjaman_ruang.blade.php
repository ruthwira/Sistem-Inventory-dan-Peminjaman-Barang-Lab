...
@section('content')
    <h1 class="h3 mb-3"><strong>Peminjaman</strong> Ruang</h1>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <form action="{{ route('pengguna.add_peminjaman_ruang') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-select" id="ruang_id" name="ruang_id" required>
                                            @foreach ($ruangs as $ruang)
                                                <option value="{{ $ruang['ruang_id'] }}">{{ $ruang['ruang_nama'] }}
                                                    [{{ $ruang['ruang_kapasitas'] }} Orang]</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-11">
                                        <a href="{{ route('pengguna.daftar_peminjaman_ruang') }}"
