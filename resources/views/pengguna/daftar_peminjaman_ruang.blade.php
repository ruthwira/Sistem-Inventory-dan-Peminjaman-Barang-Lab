...
@section('content')
    <h1 class="h3 mb-3"><strong>Data</strong> Peminjaman Ruangan</h1>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 float-end">
                            <a href="{{ route('pengguna.tambah_peminjaman_ruang') }}"
                                ...
                                <table class="table table-hover my-0" id="tablePeminjaman">
                                    ...
                                    <tbody>
                                        ...
                                        <td class="d-none d-md-table-cell text-center">
                                            <a href="/pengguna/ruang/peminjaman/detail/{{ $peminjaman['peminjaman_ruang_id'] }}"
