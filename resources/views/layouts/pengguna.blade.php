...
<head>
    ...
    <title>Pengguna | Laboratorium FTI</title>
    ...
    <div class="wrapper">
        <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
                <a class="sidebar-brand" href="{{ route('pengguna.index') }}">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item <?=(isset($page) && $page == 'daftar_peminjaman_ruang') ? 'active': '';?>">
                        <a class="sidebar-link" href="{{ route('pengguna.daftar_peminjaman_ruang') }}">
                    ...
                    <li class="sidebar-item <?=(isset($page) && $page == 'riwayat_peminjaman_ruang') ? 'active': '';?>">
                        <a class="sidebar-link" href="{{ route('pengguna.riwayat_peminjaman_ruang') }}">
                            <i class="align-middle" data-feather="square"></i> <span
                                class="align-middle">Riwayat Peminjaman Ruangan</span>
                        </a>
                    </li>
                    <li class="sidebar-item <?=(isset($page) && $page == 'daftar_peminjaman_alat') ? 'active': '';?>">
                        <a class="sidebar-link" href="{{ route('pengguna.daftar_peminjaman_alat') }}">
                            <i class="align-middle" data-feather="bar-chart-2"></i> <span
                                class="align-middle">Peminjaman Alat</span>
                        </a>
                    </li>
                    <li class="sidebar-item <?=(isset($page) && $page == 'riwayat_peminjaman_alat') ? 'active': '';?>">
                        <a class="sidebar-link" href="{{ route('pengguna.riwayat_peminjaman_alat') }}">
                            <i class="align-middle" data-feather="bar-chart-2"></i> <span
                                class="align-middle">Riwayat Peminjaman Alat</span>
                        </a>
                    </li>
                </ul>
            </div>
                    ...
                    <ul class="navbar-nav navbar-align">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item" href="{{ route('pengguna.profile') }}"><i class="align-middle me-1"
