...
@section('content')
    <h1 class="h3 mb-3"><strong>Detail</strong> Peminjaman Alat</h1>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            @if ($isEditable)
                                <form action="{{ route('admin.aksi_peminjaman_alat') }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="id_peminjaman_alat" id="id_peminjaman_alat"
                                        value="{{ $peminjaman['peminjaman_alat_id'] }}">
                                @else
                                    <form>
                            @endif
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-11">
                                    <a href="{{ route('admin.daftar_peminjaman_alat') }}"
