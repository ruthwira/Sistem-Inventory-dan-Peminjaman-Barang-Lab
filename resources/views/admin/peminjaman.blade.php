...
@section('content')
<h1 class="h3 mb-3"><strong>Dashboard</strong> Peminjaman</h1>
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="d-none d-md-table-cell">
                        <a href="/admin/detail_pengajuan/{{ $peminjamans[$i]['id_peminjaman_ruang'] }}" class="btn btn-sm btn-info">Detail</a>
                    </td>
                </tr>
                @endfor
            </tbody>
